...
import { chains3dpassSVG, chainsAnalogSVG, chainsBittensorPNG, chainsChainflipPNG, chainsCommuneaiPNG, chainsCreditcoinPNG, chainsDebioSVG, chainsFragnovaPNG, chainsJurPNG, chainsLiberlandPNG, chainsLogionPNG, chainsMyriadPNG, chainsPolkadotCircleSVG, chainsSelendraPNG, chainsSpannerPNG, chainsTanglePNG, chainsTorusPNG, chainsVaraPNG, chainsVtbPNG } from '../ui/logos/chains/index.js';
...
export const prodChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    info: 'selendra',
    providers: {
      'Selendra Network': 'wss://rpc.selendra.org',
      'Selendra Network X': 'wss://rpcx.selendra.org'
    },
    text: 'Selendra',
    ui: {
      color: '#00B894',
      logo: chainsSelendraPNG
    }
  },
  {
    info: 'sherpax',
